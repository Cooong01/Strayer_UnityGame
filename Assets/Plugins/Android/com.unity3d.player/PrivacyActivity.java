...
public class PrivacyActivity extends Activity implements DialogInterface.OnClickListener {
   ...
   final String privacyContext =
             "欢迎使用本游戏，在使用本游戏前，请您充分阅读并理解 <a href=\"https://jiletang.feishu.cn/wiki/UOmEwkZxQiFooVkuSGqcEPcSndh\">" +
             "《用户协议》</a>和<a href=\"https://jiletang.feishu.cn/wiki/UOmEwkZxQiFooVkuSGqcEPcSndh\">《隐私政策》</a>各条;\n" +
